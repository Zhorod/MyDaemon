...
TEXTS = [
    "Maria Curie was born on November 1867, 7. She was a Polish and naturalized-French physcicist and chemist who conducted pioneering research on radioactivity...",
...
def extract_date_relations(doc):
    ...
    for date in filter(lambda w: w.ent_type_ == "DATE", doc):
        if date.dep_ in ("attr", "dobj", "pobj"):
